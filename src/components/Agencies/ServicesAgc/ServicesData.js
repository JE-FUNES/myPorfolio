...
export const EspServicesData = [
    {
        ...
        Detail:
            "Sitios visualmente impactantes y alineados con tu marca -y la de tu cliente- para maximizar conversiones y credibilidad.",
    },
    {
        delay: 8,
        delayM: 3,
        ...
        Detail:
            "Funcionalidades adaptadas a las necesidades de tu cliente -y las de tu agencia-, garantizando escalabilidad y rendimiento óptimo.",
    },
    {
        delay: 9,
        delayM: 0,
        ...
        Detail:
            "Optimización con metatags, píxeles, Google Tag Manager y Search Console para medición y mejor rendimiento.",
    },
    {
        delay: 10,
        delayM: 0,
        ...
        Detail:
            "Infraestructura confiable para asegurar velocidad, estabilidad y disponibilidad sin interrupciones.",
    },
    {
        delay: 11,
        delayM: 0,
        ...
        Detail:
            "Seguridad y confianza con cifrado SSL y buenas prácticas en protección de datos para evitar riesgos.",
    },
    {
        delay: 12,
        delayM: 0,
        ...
        Detail:
            "Tiendas optimizadas para conversión, integradas con pagos seguros y herramientas de analítica.",
    },
];
//---- End Services Data -----

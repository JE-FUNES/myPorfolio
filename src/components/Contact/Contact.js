...
import contact_bg from "../../assets/Image/contact-bg2.png";
...
const Contact = () => {
    const handleCalendar = () => {
        ...
        // Abre el pop-up
        window.open('https://calendar.app.google/VjrtmJCxjv8H4Rfo6', '_blank', options);
    }
                    ...
                    <div className="col-span-12 md:col-span-6">
                      <div>
                        ...
                        <input
                          name="Name"
                          placeholder="Name *"
                          className="py-1 px-3 text-base w-full border border-black font-normal outline-none"
                          type="text"
                        />
                      </div>
                    </div>
              ...
              <div class="lg:max-w-[410px] w-full lg:ml-auto pt-[50px] lg:pt-0">
                ...
                <ul>
                  {ContactData.map((e, key) => {
                    return (
                      <li className="relative flex mb-9 border">
                        <div
